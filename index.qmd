...
- Introduction to image registration (75 mins)
- **Lunch break (60 mins)**
...
# Machine Learning for Cell Detection & Segmentation
From neurons to neural nets to SAM — the concepts behind the tools you already use.

{{< include slides/machine_learning.md >}}
