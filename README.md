# 2026 Open Software Summer School BrainGlobe course

 Materials for the BrainGlobe course for Open Software Summer School (OSSS) 
...
* Create a conda environment with `conda create -n quarto python=3.13`
...
* Deployed presentations can be found at `https://brainglobe.info/course-whole-brain-microscopy-analysis/#/title-slide`. 
