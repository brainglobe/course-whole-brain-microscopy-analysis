...
::: {.r-stack}
![](img/cellfinder-pre-splitting.png){.fragment fragment-index="1"}

![](img/cellfinder-post-splitting.png){.fragment fragment-index="2"}
:::
