...
`float32` and `float64` are common during image processing.
...
## Handedness of the coordinate system {.smaller}
...
:::aside
For more details on napari’s axis names, see the [napari documentation](https://napari.org/stable/guides/axis-names.html).
:::
